...
<template>
  <div class="bg-green-100 h-screen flex flex-col items-center justify-evenly">
    ...
    <div class="flex md:hidden w-full justify-between">
      <i class="fa fa-arrow-left h-14 mb-10 ml-9 text-5xl text-blue-900" @touchstart="buttonLeft" @touchmove="buttonLeft" @touchend="stop"  @mousedown="buttonLeft"></i>
      <i class="fa fa-arrow-right h-14 mb-10 mr-9 text-5xl text-blue-900" @touchstart="buttonRight" @touchmove="buttonRight" @touchend="stop"   @mousedown="buttonRight"></i>
    </div>
